...
class ForumStudenata extends StatefulWidget {
  @override
  State<ForumStudenata> createState() => _ForumStudenataState();
}

class _ForumStudenataState extends State<ForumStudenata> {
  @override
